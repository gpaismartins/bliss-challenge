...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return breakPoint; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return cookies; });
/* unused harmony export sorted */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return onScroll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return scrollTo; });
/* unused harmony export selectTab */
/* unused harmony export openVideo */
...
var breakPoint = {
    ...
    methods: {
        breakPoint: function breakPoint(opt) {
...
var cookies = {
    ...
    methods: {
        ...
        /* Bar of cookies */
        cookiesBar: function cookiesBar() {
        ...
        closeCookiesBar: function closeCookiesBar() {
            this.setCookie('CookiesAccept', 'true', 365);
            this.cookies = false;
        },
        resizeCookiesBar: function resizeCookiesBar() {
...
var selectTab = {
    ...
    methods: {
        ...
        scrollTab: function scrollTab(event) {
            var wth = event.currentTarget.offsetWidth;
        ...
        // click for left
        selectTabPrev: function selectTabPrev(elem) {
        ...
        // click for rigth
        selectTabNext: function selectTabNext(elem) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__share_vue__ = __webpack_require__(41);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_0__mixin__["a" /* EventBus */]],
    ...
    components: {
        share: __WEBPACK_IMPORTED_MODULE_1__share_vue__["a" /* default */]
    },
    ...
    mounted: function mounted() {
        var self = this;
        __WEBPACK_IMPORTED_MODULE_0__mixin__["a" /* EventBus */].$on('openModal', function (event) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
   ...
   methods: {
      /* Validate forms */
      validateBeforeSubmit: function validateBeforeSubmit(frmId) {
         var _this = this;

         this.$validator.validateAll(frmId).then(function (result) {
            if (result) {
               _this.submitForm(frmId);
               return;
            }
         }).catch(function () {});
      },
      ...
      /* Submit the form */
      submitForm: function submitForm(frmId) {
         var self = this;
         this.loading = true;
         axios({
            method: 'post',
      ...
      runOnFocus: function runOnFocus(event) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_modal_vue__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_list__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_detail__ = __webpack_require__(45);



Vue.use(__WEBPACK_IMPORTED_MODULE_1_vee_validate__["a" /* default */], { locale: 'en' });
...
var app = new Vue({
	...
	mixins: [__WEBPACK_IMPORTED_MODULE_2__mixin__["a" /* EventBus */], __WEBPACK_IMPORTED_MODULE_2__mixin__["b" /* breakPoint */], __WEBPACK_IMPORTED_MODULE_2__mixin__["c" /* cookies */], __WEBPACK_IMPORTED_MODULE_2__mixin__["d" /* onScroll */]],

	components: {
		modal: __WEBPACK_IMPORTED_MODULE_3__components_modal_vue__["a" /* default */],
		list: __WEBPACK_IMPORTED_MODULE_4__modules_list__["a" /* default */],
		detail: __WEBPACK_IMPORTED_MODULE_5__modules_detail__["a" /* default */]
	},
	...
	methods: {
		...
		callHealth: function callHealth() {
			var self = this;
			...
			axios({
				...
				if (response.data.status == 'OK') {
					self.health = true;
					Vue.nextTick(function () {
						__WEBPACK_IMPORTED_MODULE_2__mixin__["a" /* EventBus */].$emit('callList');
					});
				}
			}).catch(function (error) {
		...
		triggerRetry: function triggerRetry() {
			this.callHealth();
		},

		/* function for animate side-txt on scroll to move */
		animaSide: function animaSide() {
			var self = this;
		...
		shareThis: function shareThis() {
			__WEBPACK_IMPORTED_MODULE_2__mixin__["a" /* EventBus */].$emit('openModal', { 'name': 'share' });
		},
		...
		creatNew: function creatNew() {
			...
			axios({
				...
				self.openModal(msg);
				__WEBPACK_IMPORTED_MODULE_2__mixin__["a" /* EventBus */].$emit('sendData', response.data);
			}).catch(function (error) {});
		},
		...
		/* for open modal */
		openModal: function openModal(event) {
			__WEBPACK_IMPORTED_MODULE_2__mixin__["a" /* EventBus */].$emit('openModal', event);
		}
...
if (window.Promise === undefined) {
    window.Promise = __webpack_require__(17).default;
}
...
addListenerMulti = function addListenerMulti(el, s, fn, prv) {
    s.split(' ').forEach(function (e) {
        return el.addEventListener(e, fn, prv);
    });
};
removeListenerMulti = function removeListenerMulti(el, s, fn, prv) {
    s.split(' ').forEach(function (e) {
        return el.removeEventListener(e, fn, prv);
    });
};
...
urlParam = function urlParam(search, name) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function(setImmediate) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__finally__ = __webpack_require__(19);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
var hasPath = function hasPath(path, target) {
  ...
  var isValidPath = path.split('.').reduce(function (reducer, prop) {
    if (obj == null || (typeof obj === 'undefined' ? 'undefined' : _typeof2(obj)) !== 'object') {
...
Validator.prototype.validateAll = function validateAll(values, ref) {
  ...
  if (typeof values === 'string') {
    ...
    matcher = values.map(function (key) {
      return (typeof key === 'undefined' ? 'undefined' : _typeof2(key)) === 'object' ? Object.assign({ vmId: vmId }, key) : { name: key, vmId: vmId };
    });
  } else {
...
var VeeValidate$1 = function VeeValidate(config, _Vue) {
  ...
  this._validator = setValidator(new Validator(null, { fastExit: config && config.fastExit }, this));
...
function toDate(argument, dirtyOptions) {
  ...
  // Clone the date
  if (argument instanceof Date || (typeof argument === 'undefined' ? 'undefined' : _typeof2(argument)) === 'object' && Object.prototype.toString.call(argument) === '[object Date]') {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_plugins_dynamic_import_node_transform_object_rest_spread_node_modules_vue_loader_lib_selector_type_script_index_0_modal_vue__ = __webpack_require__(11);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_11388da0_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_modal_vue__ = __webpack_require__(43);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_plugins_dynamic_import_node_transform_object_rest_spread_node_modules_vue_loader_lib_selector_type_script_index_0_modal_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_11388da0_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_modal_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_11388da0_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_modal_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "resources\\scripts\\components\\modal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-11388da0", Component.options)
  } else {
    hotAPI.reload("data-v-11388da0", Component.options)
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_plugins_dynamic_import_node_transform_object_rest_spread_node_modules_vue_loader_lib_selector_type_script_index_0_share_vue__ = __webpack_require__(12);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3197f9d2_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_share_vue__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(13);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_plugins_dynamic_import_node_transform_object_rest_spread_node_modules_vue_loader_lib_selector_type_script_index_0_share_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3197f9d2_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_share_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3197f9d2_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_share_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "resources\\scripts\\components\\share.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3197f9d2", Component.options)
  } else {
    hotAPI.reload("data-v-3197f9d2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("section", { staticClass: "section-modal" }, [
      ...
      ? _c(
          "form",
          {
            ...
            attrs: {
              action: "formShare",
              id: "formShare",
              "data-vv-scope": "formShare",
              novalidate: ""
            },
            on: {
              submit: function($event) {
                $event.preventDefault()
                return _vm.validateBeforeSubmit("formShare")
              }
            }
          },
          [
            _c(
              "div",
              {
                staticClass: "form-group col-md-24",
                class: { "has-error": _vm.errors.has("formShare.email") }
              },
              [
                _c("input", {
                  directives: [
                ...
                _c("span", { staticClass: "help-block" }, [
                  _vm._v(_vm._s(_vm.errors.first("formShare.email")))
                ])
              ]
            ),
            _vm._v(" "),
            _c("div", { staticClass: "form-group col-md-24 checkbox" }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
            ...
            _c("div", { staticClass: "col" }, [
              _c(
                ...
                {
                  staticClass: "btn",
                  class: { disabled: !_vm.enabled, loading: _vm.loading },
                  attrs: { disabled: !_vm.enabled || _vm.loading }
                },
                [
                  _vm._v(" share "),
                  _c(
                    "samp",
                    [_c("icon", { staticClass: "spin animate-spin" })],
                    1
                  )
                ]
              )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3197f9d2", { render: render, staticRenderFns: staticRenderFns })
  }
}
  ...
  return _c("transition", [
    _vm.showing
      ? _c("div", { staticClass: "modal" }, [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "modal-inside" }, [
            _c("div", {
            ...
            _c(
              "div",
              { staticClass: "modal-contem" },
              [_c(_vm.componentHtml, { tag: "component" })],
              1
            )
          ])
        ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-11388da0", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* harmony default export */ __webpack_exports__["a"] = ({
   ...
   mixins: [__WEBPACK_IMPORTED_MODULE_0__mixin__["a" /* EventBus */], __WEBPACK_IMPORTED_MODULE_0__mixin__["d" /* onScroll */], __WEBPACK_IMPORTED_MODULE_0__mixin__["e" /* scrollTo */]],
   ...
   methods: {
      ...
      showDetail: function showDetail(idx) {
      ...
      backToList: function backToList(idx) {
         window.history.back();
         this.detail = false;
         this.msg = '';
         this.lang = '';
      ...
      /* call for volte */
      voteLang: function voteLang(lang) {
         var self = this;
         this.lang = lang;
         axios({
            method: 'put',
   ...
   mounted: function mounted() {
      var self = this;
      __WEBPACK_IMPORTED_MODULE_0__mixin__["a" /* EventBus */].$on('callList', function () {
         Vue.nextTick(function () {
            if (self.urlSearch) {
               self.getUrl();
            } else {
      ...
      __WEBPACK_IMPORTED_MODULE_0__mixin__["a" /* EventBus */].$on('sendData', function (data) {
         Vue.nextTick(function () {
...
/* harmony default export */ __webpack_exports__["a"] = ({
   ...
   methods: {
      ...
      /* call the item id */
      callItem: function callItem(type) {
         var self = this;
         axios({
            method: type,
            url: this.$root.urlAjax + '/questions/' + this.itemID
